...
export const Footer = ({
  ...
  return (
    <footer className={cn("bg-gray-100 dark:bg-gray-900 py-12", className)}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              Helping job seekers optimize their resumes for ATS systems and land more interviews.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="#how-it-works" className="text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
                  How It Works
                </Link>
              </li>
              <li>
